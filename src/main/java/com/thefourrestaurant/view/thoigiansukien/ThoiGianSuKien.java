...
public class ThoiGianSuKien extends VBox {
    ...
    public ThoiGianSuKien() {
        ...
        Label duongDan = new Label("Quản Lý > Thời Gian Sự Kiện");
        ...
        gridView = new ThoiGianSuKienGrid();
        // listView = new ThoiGianSuKienList();
    ...
    private HBox taoKhungGiua() {
        ...
        khungGiua.getChildren().addAll(btnList, btnGrid, lblSapXep, btnTheoChuCai, btnTheoGia, btnApDung, space);
